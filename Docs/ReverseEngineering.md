...
Bridges are handled the same way as roads (no rotation), and are now reproduced exactly. `FUN_0047c0c0` cases `0x3f..0x48` dispatch bridge/causeway tiles to specific object Ids:
