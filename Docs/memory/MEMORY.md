...
- [SimCopter heli flight model DECODED](simcopter-heli-flight-model.md) — full flight physics/controls/rotor decoded + ported (2026-07-02); units = 1/64 tile + tenth-degrees; speed = smoothed pitch; rotor lift gate 300; ported as FSimCopterFlightModel.
